...
//
//    public static com.mh.match.group.club.dto.response.ClubSimpleInfoResponseDto of(Club club, List<ClubTopicResponseDto> topics) {
//        return com.mh.match.group.club.dto.response.ClubSimpleInfoResponseDto.builder()
//            .id(club.getId())
//            .name(club.getName())
//            .coverPicUri(
