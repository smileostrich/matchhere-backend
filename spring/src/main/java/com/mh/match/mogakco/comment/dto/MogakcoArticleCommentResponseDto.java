...
@Builder
@AllArgsConstructor
public class MogakcoArticleCommentResponseDto {
    ...
    public static MogakcoArticleCommentResponseDto from(MogakcoArticleComment cac){
        return MogakcoArticleCommentResponseDto.builder()
                .id(cac.getId())
